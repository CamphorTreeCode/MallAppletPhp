...
class OrderSubmitForm extends Model
{
    ...
    {
        return [
            [['cart_id_list', 'goods_info', 'content', 'address_name', 'address_mobile','cart_list'], 'string'],
...
//                    $express_price = PostageRules::getExpressPrice($this->store_id, $address->province_id, $goods,$val->num);
        ...
        if ($order->save()) {
            ...
            $printer_setting = PrinterSetting::find()->where(['store_id' => $this->store_id, 'is_delete' => 0])->one();
