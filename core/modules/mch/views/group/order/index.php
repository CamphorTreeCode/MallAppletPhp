                        ...
                        <div class="mr-4">
                            ...
                            <div class="dropdown float-right ml-2">
                                ...
                                <div class="dropdown-menu" style="min-width:8rem">
                                    <a class="dropdown-item" href="<?= $urlManager->createUrl(['mch/group/order/index']) ?>">所有订单</a>
                                    <a class="dropdown-item" href="<?= $urlManager->createUrl(['mch/group/order/index', 'offline' => 1]) ?>">非自提</a>
                                    <a class="dropdown-item" href="<?= $urlManager->createUrl(['mch/group/order/index', 'offline' => 2]) ?>">自提</a>
                                </div>
                            </div>
                                <a class="btn btn-secondary" href="<?= Yii::$app->request->url . "&flag=EXPORT" ?>">批量导出</a>
                            </div>
                        </div>
                    </div>
                </form>
