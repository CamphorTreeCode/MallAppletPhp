        ...
        <form class="auto-form" method="post" return="<?= $returnUrl ?>">
            ...
            <div class="head">
                <div class="head-content" flex="dir:left">
                    ...
                    <a flex="cross:center" class="head-step" href="#step7">快速购买</a>
                                    ...
                                    <table class="table table-bordered attr-table">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div class="input-group">
                                                    ...
                                                    <input class="form-control form-control-sm" type="number"
                                                           style="width: 60px">
                                                    <span class="input-group-addon"><a href="javascript:" class="bat"
                                            ...
                                            <th>
                                                <div class="input-group">
                                                    <span>货号</span>
                                                    <input class="form-control form-control-sm" style="width: 60px">
                                                    <span class="input-group-addon"><a href="javascript:" class="bat"
                        ...
                        <div class="col-9 col-form-label">
                            <label class="radio-label">
                                <input <?= $goods['quick_purchase'] == 0 ? 'checked' : null ?>
                                    value="0" name="model[quick_purchase]" type="radio" class="custom-control-input">
                                <span class="label-icon"></span>
                                <span class="label-text">不添加</span>
                            </label>
                            <label class="radio-label">
                                <input <?= $goods['quick_purchase'] == 1 ? 'checked' : null ?>
                                    value="1" name="model[quick_purchase]" type="radio" class="custom-control-input">
                                <span class="label-icon"></span>
