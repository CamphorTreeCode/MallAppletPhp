...
EOF;
        ...
        try {
            $res = $this->db->createCommand("INSERT INTO {$admin_table_name} VALUES (1,'{$this->admin_username}','{$admin_password}','{$auth_key}','{$access_token}',0,0,0,'[\"coupon\",\"share\",\"topic\",\"video\",\"copyright\"]','',0)")->execute();
            if ($res) {
